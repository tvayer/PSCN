/* genspecialg.c  version 1.2; B D McKay, Sep 22, 2017 */
...
main(int argc, char *argv[])
{
    ...
    for (j = 1; !badargs && j < argc; ++j)
    {
		...
		else SWSEQUENCEMIN('b',",",bswitch,bargs,2,2,nbargs,"genspecialg -b")
    ...
    for (j = 1; !badargs && j < argc; ++j)
    {
		...
		{
		    SWSEQUENCEMIN('b',",",bswitch,bargs,2,2,nbargs,"genspecialg -b")
